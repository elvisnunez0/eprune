...
class PostTrainMetricsSaver(object):
    def __init__(
        self,
        cfg: Namespace,
        logger: Logger,
        ...
        self.metrics_name = getattr(cfg, "metrics.post_train.metric_name")
    ...
    def save(self, metrics: Dict):
        ...
        self.logger.info(f"Saved {self.metrics_name} metrics to {self.metrics_path}.")
